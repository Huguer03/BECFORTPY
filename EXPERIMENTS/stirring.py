...
def graf_densidad(L, density, t):
    ...
    plt.savefig(f'/home/hugo/Hugo_OMEN/TFG/GrAL/figuras/stirring/{str(t)}_densidad.png', dpi=300)
    plt.close()
...
def graf_phase(L, phase, t):
    ...
    plt.savefig(f'/home/hugo/Hugo_OMEN/TFG/GrAL/figuras/stirring/{str(t)}_phase.png', dpi=300)
    plt.close()
...
def nucleazioa():
    ...
    for i in t:
        if i > 15:
            ...
            gy += 0.1
        sim.hydrodynamics(t_max=dt,dt=1e-3, gamma=(10.0,gy))
